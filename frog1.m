...
function frog1()
 ...
 fgr = figure('Position',[100 300 500 450],...
            'WindowKeyPressFcn',@presskeys,...
            'WindowButtonDownFcn',@presionaMouse,...
            'closereq',@cierraFigura,'menubar','none'); 

...
function Win()
    ...
    over = 1;
    clear sound
    [MGTC, MGTC_fps] = audioread('MOM GET THE CAMERA - MLG Sound Effects (HD).mp3');
    sound(MGTC, MGTC_fps);
    youwin1()
    pause(16)
    delete(gca)
